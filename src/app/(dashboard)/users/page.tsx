            ...
            <div className="flex items-center gap-2 p-2">
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-background border border-border border-l-0 rounded-md pl-5 pr-8 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary text-foreground min-w-[120px] shadow-md shadow-black/20"
                > 
